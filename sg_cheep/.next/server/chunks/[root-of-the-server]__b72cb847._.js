...
async function POST(request) {
    try {
        ...
        const filteredHotels = mockHotels.filter((hotel)=>hotel.location.toLowerCase().includes(destination.toLowerCase()) || destination.toLowerCase().includes('singapore'));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b72cb847._.js.map