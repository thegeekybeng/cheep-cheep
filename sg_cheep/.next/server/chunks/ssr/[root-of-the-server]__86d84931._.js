...
;
const metadata = {
    title: 'SG Cheep - Singapore Travel Deals',
    description: 'Find the best hotel and travel deals in Singapore. Compare prices from Booking, Agoda, Trip.com and more!'
};
