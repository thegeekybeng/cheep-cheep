...
"[project]/app/store/useAppStore.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useAppStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        // Comparison state
        selectedHotels: [],
        addToComparison: (hotelId)=>set((state)=>({
                    selectedHotels: state.selectedHotels.includes(hotelId) ? state.selectedHotels : [
                        ...state.selectedHotels,
                        hotelId
                    ]
                })),
        removeFromComparison: (hotelId)=>set((state)=>({
                    selectedHotels: state.selectedHotels.filter((id)=>id !== hotelId)
                })),
        clearComparison: ()=>set({
                selectedHotels: []
            })
...
"[project]/app/services/BookingService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
// Mock API endpoints - in real implementation, these would be actual APIs
const API_ENDPOINTS = {
    booking: 'https://api.booking.com/v1/hotels',
    agoda: 'https://api.agoda.com/v1/hotels',
    trip: 'https://api.trip.com/v1/hotels',
    google: 'https://api.google.com/travel/v1/hotels',
    // Our own backend for aggregated data
    sgCheep: '/api/hotels'
};
class BookingService {
    ...
    // Search hotels across all platforms
    async searchHotels(params) {
        try {
            // In a real implementation, you would call multiple APIs in parallel
    ...
    // Get prices from Booking.com
    async getBookingPrices(hotelIds) {
        try {
            // Mock implementation
            return hotelIds.reduce((acc, id)=>{
                acc[id] = Math.floor(Math.random() * 200) + 100;
                return acc;
            }, {});
        } catch (error) {
            console.error('Error fetching Booking.com prices:', error);
            return {};
        }
    }
    // Get prices from Agoda
    async getAgodaPrices(hotelIds) {
        try {
            // Mock implementation
            return hotelIds.reduce((acc, id)=>{
                acc[id] = Math.floor(Math.random() * 200) + 100;
            ...
            console.error('Error fetching Agoda prices:', error);
            return {};
        }
    }
    // Get prices from Trip.com
    async getTripPrices(hotelIds) {
        try {
            // Mock implementation
            return hotelIds.reduce((acc, id)=>{
                acc[id] = Math.floor(Math.random() * 200) + 100;
            ...
            console.error('Error fetching Trip.com prices:', error);
            return {};
        }
    }
    // Get prices from Google
    async getGooglePrices(hotelIds) {
        try {
            // Mock implementation
            return hotelIds.reduce((acc, id)=>{
                acc[id] = Math.floor(Math.random() * 200) + 100;
    ...
    // Get our best aggregated prices
    async getSgCheepPrices(hotelIds) {
        try {
            // Get prices from all platforms and find the best deal
            const [booking, agoda, trip, google] = await Promise.all([
                this.getBookingPrices(hotelIds),
                this.getAgodaPrices(hotelIds),
                this.getTripPrices(hotelIds),
                this.getGooglePrices(hotelIds)
            ]);
            return hotelIds.reduce((acc, id)=>{
                const prices = [
                    booking[id] || Infinity,
                ...
                // Our price is 5-15% better than the best market price
                const discount = Math.random() * 0.1 + 0.05 // 5-15%
                ;
                acc[id] = Math.floor(bestPrice * (1 - discount));
                return acc;
            }, {});
        } catch (error) {
            console.error('Error calculating SG Cheep prices:', error);
            return {};
        }
    }
    // Get all prices for comparison
    async getAllPrices(hotelIds) {
        try {
            const [booking, agoda, trip, google, sgCheep] = await Promise.all([
                this.getBookingPrices(hotelIds),
                this.getAgodaPrices(hotelIds),
                this.getTripPrices(hotelIds),
                this.getGooglePrices(hotelIds),
                this.getSgCheepPrices(hotelIds)
            ]);
            return {
                booking,
                agoda,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(BookingService, "instance", void 0);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/store/useAppStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$BookingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/services/BookingService.ts [app-client] (ecmascript)");
;
...
function SearchForm() {
    _s();
    const { searchParams, setSearchParams, setHotels, setLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    ...
    const handleSearch = async ()=>{
        ...
        setLoading(true);
        try {
            const hotels = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$BookingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bookingService"].searchHotels(searchParams);
            setHotels(hotels);
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        placeholder: "Singapore, Marina Bay...",
                                        className: "w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cheep-primary focus:border-transparent"
                                    }, void 0, false, {
                                        fileName: "[project]/app/components/SearchForm.tsx",
                                        lineNumber: 43,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        className: "w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cheep-primary focus:border-transparent appearance-none",
                                        children: [
...
_s(SearchForm, "mmhKSuVjn+1Ow6xoYwT55xy9dVQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c = SearchForm;
var _c;
...
"[project]/app/components/FeaturedDeals.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>FeaturedDeals
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                fileName: "[project]/app/components/FeaturedDeals.tsx",
                                lineNumber: 81,
                                columnNumber: 13
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute top-0 right-0 bg-red-500 text-white px-2 py-1 rounded-lg text-sm font-semibold",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...Array(5)
                                                ...
                                                className: "h-4 w-4 ".concat(i < Math.floor(deal.rating) ? 'text-yellow-400 fill-current' : 'text-gray-300')
                                            }, i, false, {
                                                fileName: "[project]/app/components/FeaturedDeals.tsx",
                                                lineNumber: 97,
                                                columnNumber: 19
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                            ...
                            children: deal.features.slice(0, 3).map((feature, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                    className: "flex items-center",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c = FeaturedDeals;
var _c;
__turbopack_context__.k.register(_c, "FeaturedDeals");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/components/PriceComparison.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>PriceComparison
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
...
function PriceComparison() {
    ...
    const cheapest = priceData.reduce((min, current)=>current.price < min.price ? current : min);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                        ...
                        children: "Marina Bay Sands"
                    }, void 0, false, {
                        fileName: "[project]/app/components/PriceComparison.tsx",
                        lineNumber: 63,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-gray-600",
                        children: "2 nights • 2 adults • Dec 25-27, 2024"
                    }, void 0, false, {
                        fileName: "[project]/app/components/PriceComparison.tsx",
                        lineNumber: 64,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: priceData.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "card relative ".concat(item.platform === cheapest.platform ? 'ring-2 ring-green-500 bg-green-50' : ''),
                        children: [
                            item.platform === cheapest.platform && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute -top-2 left-4 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold",
                                children: "Best Deal!"
                            }, void 0, false, {
                                fileName: "[project]/app/components/PriceComparison.tsx",
                                lineNumber: 79,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    item.platform === 'SG Cheep' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "bg-cheep-primary text-white px-2 py-1 rounded text-xs",
                                        children: "OUR PRICE"
                                    }, void 0, false, {
                                        fileName: "[project]/app/components/PriceComparison.tsx",
                                        lineNumber: 90,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-3",
                                children: [
                                    item.originalPrice && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-sm text-gray-500 line-through",
                                        children: [
                                            "SGD $",
                                            item.originalPrice
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "w-full py-2 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2 ".concat(item.platform === 'SG Cheep' ? 'bg-cheep-primary hover:bg-orange-600 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-800'),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: "Book Now"
                                    }, void 0, false, {
                            ...
                            item.platform === 'SG Cheep' && item.originalPrice && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        "💰 You save SGD $",
                        Math.min(...priceData.slice(1).map((p)=>p.price)) - cheapest.price,
...
_c = PriceComparison;
var _c;
__turbopack_context__.k.register(_c, "PriceComparison");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_72645f45._.js.map